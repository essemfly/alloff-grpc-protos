...
python3 -m grpc_tools.protoc --descriptor_set_out=true --include_imports=. --proto_path=protos --python_out=./gen/pyalloff --grpc_python_out=./gen/pyalloff ./protos/*.proto
