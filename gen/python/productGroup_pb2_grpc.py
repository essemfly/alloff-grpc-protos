...
class ProductGroupStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PushProductsInProductGroup = channel.unary_unary(
                ...
                request_serializer=productGroup__pb2.PushProductsInPgRequest.SerializeToString,
                response_deserializer=productGroup__pb2.PushProductsInPgResponse.FromString,
                )
        self.RemoveProductInProductGroup = channel.unary_unary(
                ...
                response_deserializer=productGroup__pb2.RemoveProductInPgResponse.FromString,
                )
...
def add_ProductGroupServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PushProductsInProductGroup': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=productGroup__pb2.PushProductsInPgRequest.FromString,
                    response_serializer=productGroup__pb2.PushProductsInPgResponse.SerializeToString,
            ),
            'RemoveProductInProductGroup': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=productGroup__pb2.RemoveProductInPgResponse.SerializeToString,
            ),
    }
...
class ProductGroup(object):
    ...
    def PushProductsInProductGroup(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/protos.ProductGroup/PushProductsInProductGroup',
            productGroup__pb2.PushProductsInPgRequest.SerializeToString,
            productGroup__pb2.PushProductsInPgResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RemoveProductInProductGroup(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/protos.ProductGroup/RemoveProductInProductGroup',
            ...
            productGroup__pb2.RemoveProductInPgResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
