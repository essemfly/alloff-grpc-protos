...
import topbanner_pb2 as topbanner__pb2
...
class TopBannerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListTopBanners = channel.unary_unary(
                '/golang.TopBanner/ListTopBanners',
        ...
        self.EditTopBanner = channel.unary_unary(
                '/golang.TopBanner/EditTopBanner',
        ...
        self.CreateTopBanner = channel.unary_unary(
                '/golang.TopBanner/CreateTopBanner',
...
def add_TopBannerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'golang.TopBanner', rpc_method_handlers)
...
class TopBanner(object):
    ...
    def GetTopBanner(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/golang.TopBanner/GetTopBanner',
    ...
    def ListTopBanners(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/golang.TopBanner/ListTopBanners',
    ...
    def EditTopBanner(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/golang.TopBanner/EditTopBanner',
    ...
    def CreateTopBanner(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/golang.TopBanner/CreateTopBanner',
