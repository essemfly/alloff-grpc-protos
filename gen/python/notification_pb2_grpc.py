...
class NotificationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateNoti = channel.unary_unary(
                '/golang.Notification/CreateNoti',
...
def add_NotificationServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'golang.Notification', rpc_method_handlers)
...
class Notification(object):
    ...
    def ListNoti(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/golang.Notification/ListNoti',
    ...
    def CreateNoti(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/golang.Notification/CreateNoti',
    ...
    def SendNoti(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/golang.Notification/SendNoti',
