...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=goalloff.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_health_proto_rawDesc = []byte{
	...
	0x67, 0x6f, 0x61, 0x6c, 0x6c, 0x6f, 0x66, 0x66, 0x22, 0x2e, 0x0a, 0x12, 0x48, 0x65, 0x61, 0x6c,
	...
	0x32, 0x2b, 0x2e, 0x67, 0x6f, 0x61, 0x6c, 0x6c, 0x6f, 0x66, 0x66, 0x2e, 0x48, 0x65, 0x61, 0x6c,
	...
	,
...
var file_health_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: goalloff.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: goalloff.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: goalloff.HealthCheckResponse
}
var file_health_proto_depIdxs = []int32{
	0, // 0: goalloff.HealthCheckResponse.status:type_name -> goalloff.HealthCheckResponse.ServingStatus
	1, // 1: goalloff.Health.Check:input_type -> goalloff.HealthCheckRequest
	1, // 2: goalloff.Health.Watch:input_type -> goalloff.HealthCheckRequest
	2, // 3: goalloff.Health.Check:output_type -> goalloff.HealthCheckResponse
	2, // 4: goalloff.Health.Watch:output_type -> goalloff.HealthCheckResponse
