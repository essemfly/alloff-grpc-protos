...
class PackageControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.List = channel.unary_stream(
                ...
                request_serializer=package__pb2.PackageListRequest.SerializeToString,
                response_deserializer=package__pb2.Package.FromString,
                )
        self.Create = channel.unary_unary(
                '/package.PackageController/Create',
                request_serializer=package__pb2.Package.SerializeToString,
                response_deserializer=package__pb2.Package.FromString,
                )
        self.Retrieve = channel.unary_unary(
                '/package.PackageController/Retrieve',
                request_serializer=package__pb2.PackageRetrieveRequest.SerializeToString,
                response_deserializer=package__pb2.Package.FromString,
                )
...
def add_PackageControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'List': grpc.unary_stream_rpc_method_handler(
                    servicer.List,
                    request_deserializer=package__pb2.PackageListRequest.FromString,
                    response_serializer=package__pb2.Package.SerializeToString,
            ),
            'Create': grpc.unary_unary_rpc_method_handler(
                    servicer.Create,
                    request_deserializer=package__pb2.Package.FromString,
                    response_serializer=package__pb2.Package.SerializeToString,
            ),
            'Retrieve': grpc.unary_unary_rpc_method_handler(
                    servicer.Retrieve,
                    request_deserializer=package__pb2.PackageRetrieveRequest.FromString,
                    response_serializer=package__pb2.Package.SerializeToString,
            ),
...
class PackageController(object):
    ...
    def List(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/package.PackageController/List',
            package__pb2.PackageListRequest.SerializeToString,
    ...
    def Create(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/package.PackageController/Create',
            package__pb2.Package.SerializeToString,
            package__pb2.Package.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Retrieve(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/package.PackageController/Retrieve',
            package__pb2.PackageRetrieveRequest.SerializeToString,
            package__pb2.Package.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
