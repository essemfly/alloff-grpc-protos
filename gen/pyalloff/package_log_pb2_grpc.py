...
from . import package_log_pb2 as package__log__pb2
...
class PackageLogControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.List = channel.unary_stream(
                ...
                request_serializer=package__log__pb2.PackageLogListRequest.SerializeToString,
                response_deserializer=package__log__pb2.PackageLog.FromString,
                )
        self.Create = channel.unary_unary(
                '/package_log.PackageLogController/Create',
                request_serializer=package__log__pb2.PackageLog.SerializeToString,
                response_deserializer=package__log__pb2.PackageLog.FromString,
                )
        self.Retrieve = channel.unary_unary(
                '/package_log.PackageLogController/Retrieve',
                request_serializer=package__log__pb2.PackageLogRetrieveRequest.SerializeToString,
                response_deserializer=package__log__pb2.PackageLog.FromString,
                )
...
def add_PackageLogControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'List': grpc.unary_stream_rpc_method_handler(
                    servicer.List,
                    request_deserializer=package__log__pb2.PackageLogListRequest.FromString,
                    response_serializer=package__log__pb2.PackageLog.SerializeToString,
            ),
            'Create': grpc.unary_unary_rpc_method_handler(
                    servicer.Create,
                    request_deserializer=package__log__pb2.PackageLog.FromString,
                    response_serializer=package__log__pb2.PackageLog.SerializeToString,
            ),
            'Retrieve': grpc.unary_unary_rpc_method_handler(
                    servicer.Retrieve,
                    request_deserializer=package__log__pb2.PackageLogRetrieveRequest.FromString,
                    response_serializer=package__log__pb2.PackageLog.SerializeToString,
            ),
...
class PackageLogController(object):
    ...
    def List(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/package_log.PackageLogController/List',
            package__log__pb2.PackageLogListRequest.SerializeToString,
            package__log__pb2.PackageLog.FromString,
    ...
    def Create(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/package_log.PackageLogController/Create',
            package__log__pb2.PackageLog.SerializeToString,
            package__log__pb2.PackageLog.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Retrieve(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/package_log.PackageLogController/Retrieve',
            package__log__pb2.PackageLogRetrieveRequest.SerializeToString,
            package__log__pb2.PackageLog.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
