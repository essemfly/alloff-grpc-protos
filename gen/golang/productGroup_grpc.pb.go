...
func (c *productGroupClient) GetProductGroup(ctx context.Context, in *GetProductGroupRequest, opts ...grpc.CallOption) (*GetProductGroupResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/golang.ProductGroup/GetProductGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productGroupClient) CreateProductGroup(ctx context.Context, in *CreateProductGroupRequest, opts ...grpc.CallOption) (*CreateProductGroupResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/golang.ProductGroup/CreateProductGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productGroupClient) ListProductGroups(ctx context.Context, in *ListProductGroupsRequest, opts ...grpc.CallOption) (*ListProductGroupsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/golang.ProductGroup/ListProductGroups", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productGroupClient) EditProductGroup(ctx context.Context, in *EditProductGroupRequest, opts ...grpc.CallOption) (*EditProductGroupResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/golang.ProductGroup/EditProductGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productGroupClient) PushProductsInProductGroup(ctx context.Context, in *ProductInPgRequest, opts ...grpc.CallOption) (*ProductsInPgResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/golang.ProductGroup/PushProductsInProductGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productGroupClient) UpdateProductsInProductGroup(ctx context.Context, in *ProductsInPgRequest, opts ...grpc.CallOption) (*ProductsInPgResponse, error) {
	out := new(ProductsInPgResponse)
	err := c.cc.Invoke(ctx, "/golang.ProductGroup/UpdateProductsInProductGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productGroupClient) RemoveProductInProductGroup(ctx context.Context, in *RemoveProductInPgRequest, opts ...grpc.CallOption) (*ProductsInPgResponse, error) {
	out := new(ProductsInPgResponse)
	err := c.cc.Invoke(ctx, "/golang.ProductGroup/RemoveProductInProductGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductGroup_GetProductGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/golang.ProductGroup/GetProductGroup",
	}
...
func _ProductGroup_CreateProductGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/golang.ProductGroup/CreateProductGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductGroup_ListProductGroups_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/golang.ProductGroup/ListProductGroups",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductGroup_EditProductGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/golang.ProductGroup/EditProductGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductGroup_PushProductsInProductGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/golang.ProductGroup/PushProductsInProductGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductGroup_UpdateProductsInProductGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/golang.ProductGroup/UpdateProductsInProductGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductGroup_RemoveProductInProductGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/golang.ProductGroup/RemoveProductInProductGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ProductGroup_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "golang.ProductGroup",
